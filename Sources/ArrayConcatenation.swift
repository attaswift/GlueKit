...
class ArrayConcatenation<First: ObservableArrayType, Second: ObservableArrayType>: _AbstractObservableArray<First.Element>, SignalDelegate where First.Element == Second.Element {
