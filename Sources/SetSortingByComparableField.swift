...
//  Copyright © 2016--2017. Károly Lőrentey. All rights reserved.
//
...
extension ObservableSetType where Element: AnyObject, Change == SetChange<Element> {
    ...
    public func sorted<Field: ObservableValueType>(by transform: @escaping (Element) -> Field) -> AnyObservableArray<Element> where Field.Value: Comparable, Field.Change == ValueChange<Field.Value> {
